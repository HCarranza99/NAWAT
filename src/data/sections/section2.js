...
const section2 = {
    ...
    lessons: [
      ...
      // ── L4 — Mi familia ──
      {
        ...
        items: [
          { id: "s2-l4-1", type: "flashcard", nahuat_word: "Nan", spanish_translation: "Madre", pronunciation: "nan", pronunciationText: "nan" },
          { id: "s2-l4-2", type: "flashcard", nahuat_word: "Taj", spanish_translation: "Padre", pronunciation: "taj", pronunciationText: "taj" },
          { id: "s2-l4-3", type: "flashcard", nahuat_word: "Tekuyu", spanish_translation: "Abuelo", pronunciation: "te-ku-yu", pronunciationText: "te ku yu" },
          { id: "s2-l4-4", type: "multiple_choice_text", nahuat_word: "Nan", spanish_translation: "Madre", pronunciationText: "nan",
            options: [{ id: "a", text: "Padre", correct: false },{ id: "b", text: "Madre", correct: true },{ id: "c", text: "Abuelo", correct: false },{ id: "d", text: "Niño", correct: false }] },
          { id: "s2-l4-5", type: "matching", instruction: "Une cada miembro de la familia",
            pairs: [{ nahuat: "Nan", spanish: "Madre" },{ nahuat: "Taj", spanish: "Padre" },{ nahuat: "Tekuyu", spanish: "Abuelo" }] },
          { id: "s2-l4-6", type: "multiple_choice_text", nahuat_word: "Taj", spanish_translation: "Padre", pronunciationText: "taj",
            options: [{ id: "a", text: "Madre", correct: false },{ id: "b", text: "Abuelo", correct: false },{ id: "c", text: "Padre", correct: true },{ id: "d", text: "Hombre", correct: false }] },
        ],
      },
    ],
    ...
    boss: {
      ...
      items: [
        ...
        { id: "s2-b-5", type: "matching", instruction: "Une familia con su palabra",
          pairs: [{ nahuat: "Nan", spanish: "Madre" },{ nahuat: "Taj", spanish: "Padre" },{ nahuat: "Tekuyu", spanish: "Abuelo" },{ nahuat: "Piltzin", spanish: "Niño" }] },
        { id: "s2-b-6", type: "build_sentence", instruction: "Ordena: 'Yo me llamo...'", spanish_translation: "Yo me llamo...",
          word_bank: ["nutukay", "Naja"], correct_order: ["Naja", "nutukay"] },
        { id: "s2-b-7", type: "multiple_choice_text", nahuat_word: "Nan", spanish_translation: "Madre", pronunciationText: "nan",
          options: [{ id: "a", text: "Padre", correct: false },{ id: "b", text: "Madre", correct: true },{ id: "c", text: "Abuela", correct: false },{ id: "d", text: "Mujer", correct: false }] },
        { id: "s2-b-8", type: "multiple_choice_text", nahuat_word: "Takat", spanish_translation: "Hombre", pronunciationText: "ta kat",
          options: [{ id: "a", text: "Mujer", correct: false },{ id: "b", text: "Niño", correct: false },{ id: "c", text: "Hombre", correct: true },{ id: "d", text: "Padre", correct: false }] },
        { id: "s2-b-9", type: "build_sentence", instruction: "Ordena: 'El hombre se llama...'", spanish_translation: "El hombre se llama...",
          word_bank: ["tukay", "Takat"], correct_order: ["Takat", "tukay"] },
        { id: "s2-b-10", type: "multiple_choice_text", nahuat_word: "Tekuyu", spanish_translation: "Abuelo", pronunciationText: "te ku yu",
          options: [{ id: "a", text: "Abuelo", correct: true },{ id: "b", text: "Padre", correct: false },{ id: "c", text: "Hombre", correct: false },{ id: "d", text: "Niño", correct: false }] },
      ],
    },
  };
