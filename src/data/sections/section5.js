    ...
    lessons: [
      // ── L1 — Estar y tener ──
      {
        ...
        items: [
          ...
          { id: "s5-l1-6", type: "build_sentence", instruction: "Ordena: 'Yo estoy aquí'", spanish_translation: "Yo estoy (vivo)",
            word_bank: ["nemi", "Naja"], correct_order: ["Naja", "nemi"] },
        ],
      },
      // ── L2 — Ir ──
      {
        ...
        items: [
          ...
          { id: "s5-l2-3", type: "build_sentence", instruction: "Ordena: 'Yo voy'", spanish_translation: "Yo voy",
            word_bank: ["yawi", "Naja"], correct_order: ["Naja", "yawi"] },
      ...
      // ── L3 — Comer, beber y dormir ──
      {
        ...
        items: [
          ...
          { id: "s5-l3-4", type: "build_sentence", instruction: "Ordena: 'Yo duermo'", spanish_translation: "Yo duermo",
            word_bank: ["kuchi", "Naja"], correct_order: ["Naja", "kuchi"] },
      ...
      // ── L4 — Reír y sentirse bien ──
      {
        ...
        items: [
          ...
          { id: "s5-l4-2", type: "flashcard", nahuat_word: "Yek", spanish_translation: "Bueno / Bien", pronunciation: "yek", pronunciationText: "yek" },
          ...
          { id: "s5-l4-4", type: "multiple_choice_text", nahuat_word: "Yek", spanish_translation: "Bueno / Bien", pronunciationText: "yek",
          ...
          { id: "s5-l4-6", type: "build_sentence", instruction: "Ordena: 'Yo estoy feliz'", spanish_translation: "Yo estoy feliz",
            word_bank: ["paki", "Naja"], correct_order: ["Naja", "paki"] },
        ],
      },
    ],
    ...
    boss: {
      ...
      items: [
        ...
        { id: "s5-b-6", type: "build_sentence", instruction: "Ordena: 'Yo voy'", spanish_translation: "Yo voy",
          word_bank: ["Naja", "yawi"], correct_order: ["Naja", "yawi"] },
        ...
        { id: "s5-b-9", type: "multiple_choice_text", nahuat_word: "Yek", spanish_translation: "Bueno / Bien", pronunciationText: "yek",
        ...
        { id: "s5-b-10", type: "build_sentence", instruction: "Ordena: 'Yo estoy feliz'", spanish_translation: "Yo estoy feliz",
          word_bank: ["Naja", "paki"], correct_order: ["Naja", "paki"] },
      ],
    },
  };
