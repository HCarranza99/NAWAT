...
const hojaCorpus = {
  ...
  rows: [
    ...
    [null, C('Formas marcadas con guion'), C(ligadas), C('El diccionario las escribe con guion inicial (−Pia, −Tukey): no van sueltas, exigen prefijo. La app ya las excluye de las lecciones generadas.')],
...
const PREGUNTAS = [
  ...
  ['Formas con guion', 'El diccionario marca con guion las formas que exigen prefijo. La app las enseña ya prefijadas: Nikpia "yo tengo", Nikuni "yo bebo", Nutukey "mi nombre". ¿Es la manera correcta de presentárselas a un principiante, o conviene enseñar la raíz y el prefijo por separado?'],
  ['✔ Itukey — RESUELTA', 'Contestada el 14-ago-2026: la app decía "Takat itukay" y Héctor la corrigió a "Ne takat itukey", con artículo y con e. Ya está aplicado. Queda acá como registro.'],
  ['Saludo de tarde y noche', 'Héctor confirmó que el saludo de la mañana en Witzapan es "Yek peyna" (no "Yek tunal", que es de otra variante). Siguiendo ese mismo molde la app arma "Yek tiutak" para la tarde y "Yek tayua" para la noche, pero esas dos NO están confirmadas. ¿Se dicen así? ¿Y a qué hora deja de ser peyna y empieza tiutak?'],
  ['Nutunal', 'El módulo 3 propuesto se titula "Nutunal — Mi día". Pero el diccionario registra "Nutunal: Mi vida, mi espíritu, mi energía, mi fuerza" (p.223). ¿"Nutunal" se entiende como "mi día", o conviene otro título para no dar a entender otra cosa?'],
