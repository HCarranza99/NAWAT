  ...
  return (
    <div className="space-y-2.5 px-4 pb-20 pt-4">
      ...
      <div>
        ...
        <h2 className="mt-0.5 flex items-start gap-1.5 text-[1.8rem] font-black leading-[1.02] tracking-tight text-[#17211d]">
      ...
      {next ? (
        ...
        >
          ...
          <div className="relative z-10 max-w-[64%]">
            ...
            <h3 className="mt-2.5 text-[1.35rem] font-black leading-tight tracking-tight text-white">{next.lesson.title}</h3>
            <p className="mt-1 line-clamp-1 text-[0.82rem] font-semibold leading-snug text-white/60">{next.lesson.description}</p>
            ...
            <div className="mt-3 inline-flex items-center gap-2 rounded-full bg-gradient-to-b from-[#f7b076] to-[#f4a261] px-6 py-2.5 text-sm font-black text-[#102f29] shadow-[0_4px_0_#c47330,0_10px_20px_rgba(244,162,97,0.3)] transition-transform duration-150 group-active:translate-y-[3px] group-active:shadow-[0_1px_0_#c47330]">
          ...
          <div className="pointer-events-none absolute -bottom-1 -right-1 z-10 drop-shadow-[0_12px_22px_rgba(0,0,0,0.34)]">
            <Torogoz emotion={next.isBoss ? 'proud' : 'explaining'} size={120} />
          </div>
        </motion.button>
      ) : (
